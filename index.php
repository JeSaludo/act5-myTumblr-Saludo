...
$acc_username = "admin";
$acc_password = "admin";
$acc_fullname = "Jan Eris Saludo";
$acc_address = "Marinduque, Philippines";
		...
		<div class="container">
			<div class="row justify-content-center">
	            ...
	            <div class="form-group d-flex">
	              <input type="password" class="form-control rounded-left" name= "form_password" placeholder="Password" required>
	            </div>
